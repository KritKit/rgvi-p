...
public class explicit_game7 : MonoBehaviour
{
    ...
    private void EndGame()
    {
        ...
        //เล่นด่านเดิม
        explicit_script.checkscorenumber = 7;

        explicit_script.checkstagenumber = 7;
    ...
    private void FinGame()
    {
        ...
        explicit_script.checkstagenumber = 8;
